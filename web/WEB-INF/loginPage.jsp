...
<div class="container">
    ...
    <form class="form-signin" method="post" action="LoginServlet">
        ...
        <input type="email" id="email" class="form-control" value="${param.email}" name="email" placeholder="Email address" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" class="form-control" value="${param.password}" name="password" placeholder="Password" required>
        <div class="checkbox">
            <label>
